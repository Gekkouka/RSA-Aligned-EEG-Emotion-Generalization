...
class BaseWithRSA(nn.Module):
    def __init__(self,
                 ...
                 **kwargs):
        super(BaseWithRSA, self).__init__()
        ...
        self.rdm_criterion = RDMAlignLoss(distance="euclidean")
    ...
    def forward(self, source, target, source_label):
        ...
        rdm_loss = self.rdm_criterion(source_feature, target_feature)
        return cls_loss, trans_loss, rdm_loss
