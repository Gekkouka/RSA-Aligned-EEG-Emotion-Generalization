...
class Trainer:
    ...
    def train_one_epoch(self, source_ds, target_ds, source_cache=None, target_cache=None):
        ...
        for _ in range(self.steps_per_epoch):
            ...
            loss = total_cls + self.transfer_loss_weight * total_transfer
            loss.backward()
            self.optimizer.step()
        ...
        return loss_clf.avg, loss_transfer.avg, train_acc
    ...
    def _log_epoch(self, epoch, loss_clf, loss_transfer, acc, train_acc):
    ...
    def train(self, source_ds, target_ds, debug_one_epoch=False):
        ...
        if debug_one_epoch:
            loss_clf, loss_transfer, train_acc = self.train_one_epoch(
                source_ds=source_ds,
                target_ds=target_ds,
                source_cache=source_cache,
